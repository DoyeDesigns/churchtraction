...
@section('innerTitle')
    @lang('site.create-new') @lang('admin.topic')
@endsection
...
@section('breadcrumb')
    ...
    <li><span>@lang('site.create-new') @lang('admin.topic')</span>
    </li>
@endsection
...
@section('content')
    <div class="single-pro-review-area mt-t-30 mg-b-15">
        ...
        <div class="container-fluid">
            ...
            <form method="POST" autocomplete="off" action="{{ url('/member/forum-topics') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="msg_id" value="{{ $msgId }}"/>
                @include ('member.forum-topics.form', ['formMode' => 'create'])
