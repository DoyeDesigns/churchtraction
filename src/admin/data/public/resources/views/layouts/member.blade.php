        ...
        <nav class="navbar navbar-expand-lg main-navbar int_adminnav">
            ...
            @else
                <form class="form-inline mr-auto"  method="GET" action="{{ url('/member/members') }}" >
                    ...
                    <input class="form-control" disabled value="{{\App\Church::where('id', $department->church_id)->first()->name }}"  style="margin:10; color: black; font-size:20px; font-weight: bold">
                    </div>
                    <div>
                    <input class="form-control" disabled value="{{$department->name}}"  style="margin:10; color: black; font-size:20px; font-weight: bold; background-color:lightgray">
                    </div>
                    {{--
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <form id="logout-form" action="{{ route('logout') }}" method="POST" autocomplete="off" style="display: none;">
                    @csrf
                </form>
        </nav>
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fa fa-calendar"></i><span>@lang('admin.reports')</span></a>
                        <ul class="dropdown-menu">
                            {{--<li><a class="nav-link" href="{{ route('member.events.roster') }}">@lang('admin.view-roster')</a></li>--}}
                            @can('administer')
                            {{-- <li class="disabled"><a class="nav-link" href="{{ url('member/events') }}">@lang('admin.manage-events')</a></li> --}}
                            <li><a class="nav-link" href="{{ url('member/weeklyreports') }}">@lang('admin.weeklyreports')</a></li>
                            <li><a class="nav-link" href="{{ url('member/cellreports') }}">@lang('admin.cellreports')</a></li>
                            <li><a class="nav-link" href="{{ url('member/outreachreports') }}">@lang('admin.outreachreports')</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="disabled"><a class="nav-link" href="{{ route('member.members.applications') }}">@lang('admin.applications')</a></li>
                            <li class="disabled"><a class="nav-link" href="{{ route('member.members.import') }}">@lang('admin.import') @lang('admin.members')</a></li>
                    ...
                    {{--
                    <li class="dropdown disabled" aria-disabled="true">
                        <a href="#" class="nav-link has-dropdown"><i class="fa fa-user-circle"></i><span>@lang('admin.announcements')</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link disabled" href="{{ url('member/announcements') }}">@lang('admin.view-all')</a></li>
                            @can('administer')
                    ...
                    --}}
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fa fa-school"></i><span>@lang('admin.foundation')</span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#" class="nav-link has-dropdown" href="{{ url('member/foundation/create') }}">@lang('admin.classes')</a>
                                <ul class="dropdown-menu">
                                    <li class="disabled" >
                                        <a class="nav-link" href="{{ url('member/foundation/create') }}">@lang('admin.add-new')</a>
                                    </li>
                                    <li class="disabled">
                                        <a class="nav-link disabled" href="{{ url('member/foundation') }}">@lang('admin.view-all')</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="disabled">
                                <a class="nav-link disabled" href="{{ url('member/foundation') }}">@lang('admin.teachers')</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="nav-link btn btn-success btn-bg">
                        <i class="fa fa-button"> </i>  @lang('admin.go-admin-dashboard')
                    </a>
                    @endif
                    @endcan
                </ul>
