...
<style>
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 col-8">
            @can('administer')
                <a href="{{ url('member/weeklyreports') }}">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-8">
            @can('administer')
                <a href="{{ url('member/outreachreports') }}">
                    <div class="card card-statistic-1">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-12 disabled">
    ...
    <div class="row">
        {{--<div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills disabled" id="myTab3" role="tablist">
                        <li class="nav-item">
