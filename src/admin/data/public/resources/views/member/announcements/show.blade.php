            ...
            <div class="card">
                <div class="card-header">
                  ...
                  &nbsp;  <a href="{{ url('/member/announcements/' . $announcement->id . '/edit') }}" title="@lang('admin.edit') announcement"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i> @lang('admin.edit')</button></a>
                    &nbsp;
                    <form method="POST" autocomplete="off" action="{{ url('member/announcements' . '/' . $announcement->id) }}" accept-charset="UTF-8" style="display:inline">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
    ...
    @endcan
            ...
            <article class="article article-style-c">
                ...
                <div class="article-details">
                    <div class="article-category"><a href="#">{{ \Illuminate\Support\Carbon::parse($announcement->created_at)->format('d.M.Y') }}</a> <div class="bullet"></div> <a href="#">{{ \Illuminate\Support\Carbon::parse($announcement->created_at)->diffForHumans() }}</a></div>
