...
@section('content')
           ...
           <div class="card">
               ...
               <div class="card-body p-0">
                <form method="POST" autocomplete="off" action="{{ route('member.shifts.save-tasks',['shift'=>$shift->id]) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
