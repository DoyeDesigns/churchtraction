        ...
        <nav class="navbar navbar-expand-lg main-navbar int_adminnav">
            ...
            @else
                ...
                <form class="form-inline mr-auto"  method="GET" @section('t-form-action') action="{{ url('/admin/members') }}" @show >
                    ...
                    <div >
                    <input class="form-control" disabled value="Church: NDG" data-width="250" style="margin:10; color: black; font-size:20px; font-weight: bold">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fa fa-users"></i><span>@lang('admin.roles')</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{ url('admin/roles/create') }}">@lang('admin.add-new')</a></li>
                            <li><a class="nav-link" href="{{ url('admin/roles') }}">@lang('admin.view-all')</a></li>
                    ...
                    {{--
                        <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-chart-line"></i><span>@lang('admin.report')</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="{{ url('admin/sms/create') }}">@lang('admin.view-all')</a></li>
                           <li><a class="nav-link" href="{{ route('sms.inbox') }}">@lang('admin.inbox')</a></li>
                        </ul>
                    </li> --}}
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="#" class="nav-link has-dropdown" href="{{ url('admin/foundation/create') }}">@lang('admin.classes')</a>
                                <ul class="dropdown-menu">
                                    <li class="disabled">
                                        <a class="nav-link disabled" href="{{ url('admin/foundation/create') }}">@lang('admin.add-new')</a>
                                    </li>
                                    <li class="disabled">
                                        <a class="nav-link disabled" href="{{ url('admin/foundation') }}">@lang('admin.view-all')</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="disabled">
                                <a class="nav-link disabled" href="{{ url('admin/foundation') }}">@lang('admin.teachers')</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="{{ route('settings.language') }}">@lang('admin.language')</a></li>
