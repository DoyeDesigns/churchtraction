            ...
            <div class="product-payment-inner-st form-content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" autocomplete="off" action="{{ url('admin/groups' . '/' . $department->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr><th> @lang('admin.name') </th><td> {{ $department->name }} </td></tr><tr><th> @lang('admin.description') </th><td> {!! clean($department->description) !!} </td></tr>
