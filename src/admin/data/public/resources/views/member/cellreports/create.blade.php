...
@section('pageTitle',__('admin.cellreport'))

@section('innerTitle')
    @lang('site.create-new') @lang('admin.cellreport')
@endsection
...
@section('breadcrumb')
    ...
    <li><span>@lang('site.create-new') @lang('admin.cellreport')</span>
    </li>
@endsection
    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15">
        <div class="container-fluid">
            <div class="product-payment-inner-st form-content">
                <form method="POST" autocomplete="off" action="{{ url('/member/cellreports') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @include ('member.cellreports.form', ['formMode' => 'create' ])
                </form>
            </div>
        </div>
    </div>
