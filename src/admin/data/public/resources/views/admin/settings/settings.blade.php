...
@section('breadcrumb')
    ...
    <li><span>@lang("admin.setting-".$group)</span>
    </li>
@endsection
    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15">
        ...
        <div class="container-fluid">
            <div class="product-payment-inner-st form-content">
                ...
                <form method="POST" autocomplete="off" action="{{ route('admin.save-settings') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            @elseif($setting->type=='radio')
                                ...
                                @elseif($setting->type='image')
                                    ...
                                    <img class="img-fluid" src="{{ asset($setting->value) }}" style="max-width: 300px"/>
                                    <br/>
