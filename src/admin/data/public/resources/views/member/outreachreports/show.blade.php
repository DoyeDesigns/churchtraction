...
@section('breadcrumb')
    ...
    <li><span>@lang('admin.outreachreport')</span>
    </li>
@endsection
            ...
            <div class="product-payment-inner-st form-content">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/member/outreachreports') }}" title="@lang('admin.back')"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> @lang('admin.back')</button></a>
                        {{--<a href="{{ url('/member/outreachreports/' . $report->id . '/edit') }}" title="@lang('admin.edit') report"><button class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i> @lang('admin.edit')</button></a>--}}

                        {{--
                            <form method="POST" autocomplete="off" action="{{ url('member/outreachreports' . '/' . $report->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class=''>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8 {{ $errors->has('if_yes_soul_winning_comment') ? 'has-error' : ''}}">
                                    ...
                                    <textarea  class="form-control autosize" rows="20" name="if_yes_soul_winning_comment" type="textarea" id="if_yes_soul_winning_comment" >{{ $report->if_yes_soul_winning_comment }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <h4>{{'Comments'}}</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 form-group">
                                    <form method="POST" autocomplete="off" action="{{ url('/member/outreachreportcomments') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                        {{ csrf_field() }}
