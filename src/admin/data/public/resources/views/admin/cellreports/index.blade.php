...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            {{-- <h4><a class="btn btn-primary" title="@lang('site.create-new') @lang('admin.report')" href="{{ url('/admin/cellreports/create') }}"><i class="fa fa-plus" aria-hidden="true"></i> @lang('site.add-new')</a></h4>
            <div class="card-header-form">
                <form method="GET" action="{{ url('/admin/cellreports') }}">
                            ...
                            <tr>                                
                                ...
                                <td style="color:red;font-weight: bold;">                            
                                    ...
                                    <form  id="delform{{ $item->id }}" 
                                        method="POST" autocomplete="off" action="{{ url('/admin/cellreports' . '/' . $item->id) }}" 
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/admin/cellreports/' . $item->id) }}">@lang('site.view')</a>
                                            {{--<a class="dropdown-item" href="{{ url('/admin/cellreports/' . $item->id . '/edit') }}">@lang('site.edit')</a> --}}
                                            <a> 
