...
@section('content')
    <div class="single-pro-review-area mt-t-30 mg-b-15">
        ...
        <div class="container-fluid">
            ...
            <form method="POST" autocomplete="off" action="{{ url('/member/announcements/' . $announcement->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ method_field('PATCH') }}
                {{ csrf_field() }}
