        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" autocomplete="off" action="{{ url('member/events' . '/' . $event->id) }}" accept-charset="UTF-8" style="display:inline">
                        {{ method_field('DELETE') }}
                        {{ csrf_field() }}
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr><th> @lang('admin.name') </th><td> {{ $event->name }} </td></tr><tr><th> @lang('admin.venue') </th><td> {{ $event->venue }} </td></tr>
                            <tr><th> @lang('admin.description') </th><td> {!! nl2br(clean($event->description)) !!} </td></tr>
