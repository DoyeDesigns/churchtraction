...
class DepartmentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.departments.create', compact('church_branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/groups')->with('flash_message', __('admin.department').' '.__('admin.added'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/groups')->with('flash_message', __('admin.department').' '.__('admin.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/groups')->with('flash_message', __('admin.department').' '.__('admin.deleted'));
    }
