...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4>
                <form class="form-inline" method="POST" autocomplete="off" action="{{ route('members.export') }}" >
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><a  class="dropdown-item" href="{{ url('/admin/members/' . $item->id) }}" title="@lang('site.view') @lang('admin.member')">{{ $item->surname }}</a></td>
                        <td>
                        ...
                        <td>
                            ...
                            <form method="POST" autocomplete="off" action="{{ url('/admin/members' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
