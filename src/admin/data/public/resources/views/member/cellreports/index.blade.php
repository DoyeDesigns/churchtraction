...
@section('innerTitle',__('admin.cellreports'))
...
@section('breadcrumb')
    ...
    <li><span>@lang('admin.cellreports')</span>
    </li>
@endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h4><a class="btn btn-primary" title="@lang('site.create-new') @lang('admin.cellreport')" href="{{ url('/member/cellreports/create') }}"><i class="fa fa-plus" aria-hidden="true"></i> @lang('site.add-new')</a></h4>
            <div class="card-header-form">
                <form method="GET" action="{{ url('/member/cellreports') }}">
        ...
        <div class="card-body p-0">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ url('/member/cellreports/' . $item->id) }}">@lang('site.view')</a>
                                            {{--<a class="dropdown-item" href="{{ url('/member/cellreports/' . $item->id . '/edit') }}">@lang('site.edit')</a> --}}               
                                        </div>
                                    </div>


                                    <form onsubmit="return confirm('@lang('site.confirm-delete')')" id="delform{{ $item->id }}" 
                                    method="POST" autocomplete="off" action="{{ url('/member/cellreports' . '/' . $item->id) }}" 
            ...
            <div class="custom-pagination">
                {!! $cellreports->appends(['search' => Request::get('search')])->render() !!}
            </div>
        </div>
    </div>
