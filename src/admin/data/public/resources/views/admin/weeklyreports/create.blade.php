    ...
    <div class="single-pro-review-area mt-t-30 mg-b-15">
        <div class="container-fluid">
            <div class="product-payment-inner-st form-content">
                <form method="POST" autocomplete="off" action="{{ url('/admin/weeklyreports') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    @include ('admin.weeklyreports.form', ['formMode' => 'create' ])
                </form>
            </div>
        </div>
    </div>
