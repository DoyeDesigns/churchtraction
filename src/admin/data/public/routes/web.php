...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function(){
    ...
    Route::resource('cellreportcomments', 'Admin\CellReportCommentsController');
    Route::resource('outreachreportcomments', 'Admin\OutreachReportCommentsController');
    Route::resource('weeklyreportcomments', 'Admin\WeeklyReportCommentsController');
    Route::resource('weeklyreports', 'Admin\WeeklyReportsController');
    Route::resource('outreachreports', 'Admin\OutreachReportsController');
    Route::resource('cellreports', 'Admin\CellReportsController');
});
...
Route::group(['prefix'=>'member','middleware'=>['auth','department']],function(){
    ...
    Route::group(['middleware'=>'department.admin'],function(){
        ...
        Route::get('events/delete/{event}','Member\EventsController@destroy')->name('member.events.destroy');
        Route::get('events/{event}/report','Member\EventsController@reportForEvent')->name('member.events.report');
        ...
        Route::resource('weeklyreports', 'Member\WeeklyReportsController');
        Route::resource('cellreports', 'Member\CellReportsController');
        Route::resource('outreachreports', 'Member\OutreachReportsController');

        Route::resource('weeklyreportcomments', 'Member\WeeklyReportCommentsController');
        Route::resource('cellreportcomments', 'Member\CellReportCommentsController');
        Route::resource('outreachreportcomments', 'Member\OutreachReportCommentsController');
