            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>{{ $item->name }}</td>
                        <td>
                            {{\App\Church::where('id', $item->church_id)->first()->name}}
                        </td>
                        ...
                        <td>
                            ...
                            <form id="delete-{{ $item->id }}" onsubmit="return confirm('@lang('admin.delete-prompt')')" method="POST" autocomplete="off" action="{{ url('/admin/groups' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
                             </form>
