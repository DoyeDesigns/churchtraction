...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h4>@lang('admin.by') {{ $forumtopic->user->name }} @lang('admin.on') {{ \Carbon\Carbon::parse($forumtopic->created_at)->format('D d/M/Y') }}</h4>
    ...
    <div class="card" id="replybox">
        ...
        <div class="card-body">
            ...
            <form method="POST" autocomplete="off" action="{{ url('/member/forum-topics/' . $forumtopic->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
